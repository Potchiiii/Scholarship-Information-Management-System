        ...
        padding: 1rem;
              ...
              <div class="card">
                <div class="card-header">
                  <h3>Denied List of Applicants</h3>
                  <div class="">
                    <a href="applications.php" class="text-dark">Admission</a> / <a href="approved_applications.php" class="text-dark">Approved</a> / <a href="non_applications.php" class="text-danger">Denied</a> 
                  </div>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="mydata2" class="display" style="width:100%">
                      ...
                      <tbody>
                      <?php foreach ($listscholar_non as $list) { ?>
                        <tr>
